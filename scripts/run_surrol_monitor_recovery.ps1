param(
    ...
    [string]$EpisodeOut = "/mnt/e/RL_projects/constraint_surgical_rl/runs/surrol_needlepick_monitor_recovery.csv",
    [string]$StepOut = "/mnt/e/RL_projects/constraint_surgical_rl/runs/surrol_needlepick_monitor_recovery_steps.csv",
    [string]$Report = "/mnt/e/RL_projects/constraint_surgical_rl/reports/surrol_needlepick_monitor_recovery_zh.md",
