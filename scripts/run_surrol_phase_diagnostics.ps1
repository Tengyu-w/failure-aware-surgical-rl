param(
    ...
    [string]$Out = "/mnt/e/RL_projects/constraint_surgical_rl/runs/surrol_needlepick_phase_diagnostics.csv",
    [string]$SummaryOut = "/mnt/e/RL_projects/constraint_surgical_rl/runs/surrol_needlepick_phase_diagnostics_summary.csv",
    [int]$MaxSteps = 200,
