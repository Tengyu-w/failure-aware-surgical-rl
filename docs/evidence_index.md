...
| Stage 16 | Derive routes from model/rollout behavior regions | [model-derived routing report](../reports/failure_aware_vppv_model_derived_routing.md), [model-derived summary](../reports/tables/failure_aware_vppv_model_derived_summary.csv), [model-derived PCA figure](../reports/figures/failure_aware_vppv/failure_aware_vppv_model_derived_pca.png) |
...
| [failure_aware_vppv_model_derived_summary.csv](../reports/tables/failure_aware_vppv_model_derived_summary.csv) | held-out metrics for model/rollout behavior-derived route assignment |
...
| [failure_aware_vppv_model_derived_transition_points.csv](../reports/tables/failure_aware_vppv_model_derived_transition_points.csv) | first alert step and lead-time check for model-derived routes |
...
| [failure_aware_vppv_model_derived_routing.md](../reports/failure_aware_vppv_model_derived_routing.md) | model/rollout representation clustering and route assignment analysis |
